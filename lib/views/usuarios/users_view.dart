...
class _UsersViewState extends ConsumerState<UsersView> {
  ...
  Future<void> _loadData() async {
    try {
      ...
      // Verificar si el usuario actual puede agregar usuarios
      final authService = ref.read(authServiceProvider);
      final canAddUser = await authService.canAddUser(currentUser);
    ...
    return Scaffold(
      ...
      floatingActionButton:
          _canAddUser
              ? FloatingActionButton(
                onPressed: () {
                  context.push(AppRoutes.userAdd);
                },
