...
class CuentaCorrienteAddEditView extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<CuentaCorrienteAddEditView> createState() => _CuentaCorrienteAddEditViewState();
}

class _CuentaCorrienteAddEditViewState extends ConsumerState<CuentaCorrienteAddEditView> {
    ...
    try {
      ...
      if (_cuenta == null) {
        ...
        _cuenta = CuentaCorriente(
          ...
          referenciaPago: _referenciaController.text.trim().isEmpty 
              ? null 
        ...
        _cuenta!.observaciones = _observacionesController.text.trim().isEmpty 
            ? null 
            : _observacionesController.text.trim();
        _cuenta!.metodoPago = _metodoPagoController.text.trim().isEmpty 
            ? null 
            : _metodoPagoController.text.trim();
        _cuenta!.referenciaPago = _referenciaController.text.trim().isEmpty 
            ? null 
            : _referenciaController.text.trim();
      }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          widget.cuentaId == null ? 'Nueva Cuenta Corriente' : 'Editar Cuenta Corriente',
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SwitchListTile(
                            ...
                            subtitle: const Text('La cuenta estará disponible'),
                            value: _activa,
                            onChanged: (value) {
