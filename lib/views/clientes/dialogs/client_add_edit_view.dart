...
class _ClientAddEditViewState extends ConsumerState<ClientAddEditView> {
  ...
  final _whatsappController = TextEditingController(); // Cambiado de telefono
  final _instagramController = TextEditingController(); // Nuevo campo
  ...
  void _loadClienteData() {
    ...
    _whatsappController.text = cliente.whatsapp ?? ''; // Cambiado
    _instagramController.text = cliente.instagram ?? ''; // Nuevo
  ...
  void dispose() {
    ...
    _whatsappController.dispose(); // Cambiado
    _instagramController.dispose(); // Nuevo
